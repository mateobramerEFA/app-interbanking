...
if authentication_status:
    ...
    <style>
      ...
      h1 { font-family: 'Syne', sans-serif !important; font-size: 2.4rem !important; font-weight: 800 !important; letter-spacing: -0.03em !important; line-height: 1.1 !important; }

      .tag { display: inline-block; font-family: 'IBM Plex Mono', monospace; font-size: 11px; font-weight: 500; letter-spacing: 0.12em; text-transform: uppercase; color: #2d6348; background: #e8f5ee; border: 1px solid #b8ddc8; padding: 4px 12px; border-radius: 100px; margin-bottom: 16px; }

      .desc { font-size: 15px; color: #7a7870; line-height: 1.7; margin-bottom: 8px; }

      .divider { border: none; border-top: 1.5px solid #e0ddd6; margin: 28px 0; }

      .footer-note { font-family: 'IBM Plex Mono', monospace; font-size: 11px; color: #aaa; text-align: center; margin-top: 32px; letter-spacing: 0.05em; }
    </style>
